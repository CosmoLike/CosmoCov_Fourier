...
data=['10x2pt_LSSTxSO_Y1','10x2pt_fid']
...
chain_file = os.path.join(dirname, "chains/LSSTxSO_10x2pt_model_%d_modified" %model)
...
sample_params = sample_cosmology_10x2_allsys(get_N_tomo_shear(),get_N_tomo_clustering(),MG = False, cov_modified = True)
