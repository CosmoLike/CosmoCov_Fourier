...
inv=['invcov_Y1_10x2pt','invcov_Y6_3x2pt']

data=['10x2pt_LSSTxSO_Y1','3x2pt_fid']
...
sample_params = sample_cosmology_3x2_allsys(get_N_tomo_shear(),get_N_tomo_clustering(),MG=False, w0wa=False, cov_modified=False)
