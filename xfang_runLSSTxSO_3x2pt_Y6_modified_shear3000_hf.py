...
chain_file = os.path.join(dirname, "chains/LSSTxSO_3x2pt_model_%d_modified_shear3000_hf" %model)
...
sample_params = sample_cosmology_3x2_hfsys(get_N_tomo_shear(),get_N_tomo_clustering(),MG=False, w0wa=False, cov_modified=True)
