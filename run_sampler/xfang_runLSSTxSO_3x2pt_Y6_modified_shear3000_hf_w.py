...
data=['10x2pt_LSSTxSO_Y1','3x2pt_hf']
...
chain_file = os.path.join(dirname, "chains/LSSTxSO_3x2pt_model_%d_modified_shear3000_hf_w" %model)
...
sample_params = sample_cosmology_3x2_hfsys(get_N_tomo_shear(),get_N_tomo_clustering(),MG=False, w0wa=True, cov_modified=True)
