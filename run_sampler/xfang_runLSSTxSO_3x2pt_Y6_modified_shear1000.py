...
mask=['...','mask_3x2pt_shear1000.txt'] # using mask is sufficient to select correct scales
...
chain_file = os.path.join(dirname, "chains/LSSTxSO_3x2pt_model_%d_modified_shear1000" %model)
