...
inv=['invcov_Y1_10x2pt','invcov_Y6_6x2pt_modified_shear3000']

data=['10x2pt_LSSTxSO_Y1','6x2pt_fid_shear3000']

mask=['...','mask_6x2pt_shear3000.txt']
...
chain_file = os.path.join(dirname, "chains/LSSTxSO_6x2pt_model_%d_modified_shear3000" %model)
