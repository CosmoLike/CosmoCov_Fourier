...
from cosmolike_libs_RomanxCMB_10x2pt import * 
...
chain_file = os.path.join(dirname, f"chains/{survey_designation}_{probe}_modified_w0wa")
...
sample_main(sample_params,sigma_z_shear,sigma_z_clustering,3600,Nwalker,1,chain_file, blind=False, pool=MPIPool())
