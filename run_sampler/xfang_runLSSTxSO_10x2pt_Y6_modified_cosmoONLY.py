...
inv=['invcov_Y1_10x2pt',f'invcov_lsstxso_y6_modified_{probe}']

data=['10x2pt_LSSTxSO_Y1',f'{probe}_{survey_designation}']
...
chain_file = os.path.join(dirname, "chains/LSSTxSO_10x2pt_model_%d_modified_cosmoONLY" %model)
