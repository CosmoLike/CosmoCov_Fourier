...
survey_designation="LSSTxSO_Y6_s500"
probes = ['10x2pt', '3x2pt', '6x2pt', '8x2pt', '6x2pt_sy', '6x2pt_yy']
i = int(sys.argv[1])
probe = probes[i]

id_rescale = int(sys.argv[2])

inv=f'invcov_lsstxso_y6_modified_s500_{probe}_rescale_{id_rescale}'
...
chain_file = os.path.join(dirname, f"chains/{survey_designation}_{probe}_modified_rescale_{id_rescale}")
