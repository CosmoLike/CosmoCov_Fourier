...
# can only be 2 or 3
wideprior_factor = int(sys.argv[2])

inv=f'invcov_romanwide2xs4_modified_widepriorx{wideprior_factor}_{probe}'
...
chain_file = os.path.join(dirname, f"chains/{survey_designation}_{probe}_modified_w0wa_widepriorx{wideprior_factor}")
