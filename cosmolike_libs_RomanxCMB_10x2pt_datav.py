...
get_Ndata = lib.get_Ndata
get_Ndata.argtypes = []
get_Ndata.restype = ctypes.c_int
...
lib.get_data_vector.argtypes = [InputCosmologyParams, InputNuisanceParams]
get_data_vector = lib.get_data_vector
get_data_vector.restype = ctypes.POINTER(ctypes.c_double)
...
class InputNuisanceParams(IterableStruct):
    ...
    def fiducial(cls):
        c = cls()
        c.bias[:] = [1.3 + 0.1*i for i in range(10)]
