...
inv=['invcov_Y1_10x2pt','invcov_Y6_6x2pt_modified']

data=['10x2pt_LSSTxSO_Y1','6x2pt_fid']
...
chain_file = os.path.join(dirname, "chains/LSSTxSO_6x2pt_model_%d_modified" %model)
