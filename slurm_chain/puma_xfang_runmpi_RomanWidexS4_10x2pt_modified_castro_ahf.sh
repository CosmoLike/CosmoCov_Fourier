...
date
/usr/bin/time mpirun -x LD_LIBRARY_PATH --mca pml ob1 --mca btl ^openib -n ${SLURM_NTASKS} python3 run_sampler/xfang_runRomanWidexS4_nx2pt_modified_impacts.py 0 2 ${SLURM_NTASKS}
date