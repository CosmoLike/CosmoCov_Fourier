#!/bin/bash
#SBATCH --job-name=RW2xS4_10x2_1sample
...
date
/usr/bin/time mpirun -x LD_LIBRARY_PATH --mca pml ob1 --mca btl ^openib -n ${SLURM_NTASKS} python3 run_sampler/xfang_runRomanWide2xS4_nx2pt_modified_1sample_w0wa.py 0 ${SLURM_NTASKS}
