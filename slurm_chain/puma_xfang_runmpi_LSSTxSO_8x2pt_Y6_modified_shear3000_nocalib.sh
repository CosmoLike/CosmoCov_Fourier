...
date
/usr/bin/time mpirun -x LD_LIBRARY_PATH --mca pml ob1 --mca btl ^openib -n ${SLURM_NTASKS} python3 run_sampler/xfang_runLSSTxSO_8x2pt_Y6_modified_shear3000_nocalib.py ${SLURM_NTASKS}
date